...
export function PlannerPage() {
  ...
  return <section className="planner-page">
    ...
    {comparison && <section className="planner-dashboard-section scenario-comparison">
      <div className="planner-section-heading"><div><span>Decision support</span><h3>Same portfolio, four planning objectives</h3><p>All scenarios use one memoized input snapshot. Choose the trade-off, then inspect its detailed preview and run full N−1 validation.</p></div><div className="scenario-runtime"><span>Comparison runtime</span><strong>{(comparison.runtimeMs / 1000).toFixed(1)}s</strong></div></div>
